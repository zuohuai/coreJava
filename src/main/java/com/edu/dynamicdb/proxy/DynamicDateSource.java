 ...
 *
 */
public class DynamicDateSource extends AbstractRoutingDataSource implements DisposableBean {

	
	protected Object determineCurrentLookupKey() {
		return DynamicDateSourceHolder.getDataSourceName();
	}
	...
	public void test_xml_parser(){
		System.out.println("dynamicDateSource");
	}
