...
import com.edu.utils.FixThreadPoolExecutor;

/**
 * 
 * ClassName: RejectedExecutionHandler <br/>
 * Function: 无法由 FixThreadPoolExecutor 执行的任务的处理程序。<br/>
 * 修改 ThreadPoolExecutor 的附带产物 <br/>
 * date: 2016年7月28日 下午2:40:47 <br/>
 * 
 * @author hison.zhang
 * @version
 * @since JDK 1.7
