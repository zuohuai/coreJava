...
public interface Accessor {
	 ...
	 * @return 实体总数
	 */
	<PK, T extends IEntity<PK>> void listIntersection(Class<T> clazz, Collection<T> entities, Map<String, Object> keyValue, Integer offset, Integer size);
	 ...
	 * @return
	 */
	<PK, T extends IEntity<PK>> void listUnion(Class<T> clazz, Collection<T> entities, Map<String, Object> keyValue, Integer offset, Integer size);
