...
public class HibernateAccessor extends HibernateDaoSupport implements Accessor {
	...
	@SuppressWarnings("unchecked")
	@Override
	public <PK, T extends IEntity<PK>> void listAll(
	...
	@SuppressWarnings("unchecked")
	@Override
	public <PK, T extends IEntity<PK>> void listIntersection(
	...
	@SuppressWarnings("unchecked")
	@Override
	public <PK, T extends IEntity<PK>> void listUnion(
			Class<T> clz, Collection<T> entities, Map<String, Object> keyValue,
			Integer offset, Integer size) {
		final Session session = this.getSession();
		try {
	 ...
	 * @return
	 */
	public <PK, T extends IEntity<PK>> long countIntersection(
	 ...
	 * @return
	 */
	public <PK, T extends IEntity<PK>> long countUnion(
			Class<T> clz, Map<String, Object> keyValue) {
		final Session session = this.getSession();
		try {
			final Criteria countCriteria = session.createCriteria(clz);
	 ...
	 * @param callback
	 */
	public <PK, T extends IEntity<PK>> void cursor(Class<T> clz, Criterion criterion, CursorCallback<T> callback) {
		final Session session = this.getSession();
		try {
			final Criteria entityCriteria = session.createCriteria(clz);
			if(criterion!=null) {
	 ...
	 * @return
	 */
	public <PK, T extends IEntity<PK>> Collection<T> removeUnion(
			Class<T> clz, Map<String, Object> keyValue) {
	 ...
	 * @return
	 */
	public <PK, T extends IEntity<PK>> void removeIntersection(
			Class<T> clz, Map<String, Object> keyValue) {
		final Session session = this.getSession();
		try {
			final StringBuilder stringBuilder = new StringBuilder();
