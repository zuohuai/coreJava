...
import static com.edu.game.resource.schema.SchemaNames.CLASS_ATTRIBUTE_NAME;
import static com.edu.game.resource.schema.SchemaNames.PACKAGE_ATTRIBUTE_NAME;
...
import com.edu.game.resource.StorageManagerFactory;
import com.edu.game.resource.other.FormatDefinition;
import com.edu.game.resource.other.ResourceDefinition;
import com.edu.game.resource.reader.ExcelReader;
import com.edu.game.resource.reader.JsonReader;
import com.edu.game.resource.reader.ReaderHolder;
import com.edu.game.resource.reader.ResourceReader;
import com.edu.game.resource.reader.XlsxReader;
...
public class ConfigDefinitionParser extends AbstractBeanDefinitionParser {
	...
	private FormatDefinition parseFormat(Element element) {
		...
		for (int i = 0; i < child.getLength(); i++) {
			...
			String config = e.hasAttribute(SchemaNames.FORMAT_ATTRIBUTE_CONFIG) ? e.getAttribute(SchemaNames.FORMAT_ATTRIBUTE_CONFIG) : null;
	...
	private String[] getResources(String packageName) {
		try {
			...
			String name = com.edu.game.resource.anno.Resource.class.getName();
